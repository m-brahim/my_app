...
if selected3 == "Elements" :   
    with elements("dashboard1"):
	    layout1 = [dashboard.Item("first_item", 0, 0, 2, 2)]
	    
	    DATA = [{ "taste": "fruity", "chardonay": 93, "carmenere": 61, "syrah": 114 },
    ...
    with elements("dashboard2"):
	    layout2 = [dashboard.Item("second_item", 0, 0, 2, 2)]
    ...
    with elements("dashboard3"):
	    layout3 = [dashboard.Item("third_item", 0, 0, 2, 2)]
