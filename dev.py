...
if selected3 == "Elements" :   
    ...
    layout = [dashboard.Item("bar_chart", 0, 0, 4, 3),  # Positionnez votre graphique en barres ici]

    # Créez votre dashboard avec le layout défini
    dashboard_grid = dashboard.Grid(layout)
	      
    with mui.Paper(key="bar_chart"):
	    # Insérez votre code de graphique ici
	    nivo.Bar(
	        data=data3,
	        keys=['hot dog', 'burger', 'sandwich', 'kebab', 'donut'],
	        indexBy="country",
	        ...
	        colors={"scheme": "nivo"},
	        borderColor={"from": "color", "modifiers": [["darker", 1.6]]},
	        axisBottom={"tickSize": 5, "tickPadding": 5, "tickRotation": 0, "legend": "country",
	                    "legendPosition": "middle", "legendOffset": 32, "truncateTickAt": 0},
	        axisLeft={"tickSize": 5, "tickPadding": 5, "tickRotation": 0, "legend": "food",
	                  "legendPosition": "middle", "legendOffset": -40, "truncateTickAt": 0},
	        labelSkipWidth=12,
	        labelSkipHeight=12,
	        labelTextColor={"from": "color", "modifiers": [["darker", 1.6]]},
	        legends=[{
