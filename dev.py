...
if selected3 == "Elements" :   
	layout = [dashboard.Item("first_item", 0, 0, 4, 6), dashboard.Item("second_item", 4, 0, 4, 6), dashboard.Item("third_item", 8, 0, 4, 4)]
	with elements("dashboard"):
		...
		with dashboard.Grid(layout):
			...
			with mui.Paper(key="third_item"):
				with mui.AppBar(position="static", "Bar chart"):
					  mui.Toolbar()
