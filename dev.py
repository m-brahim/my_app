...
if selected3 == "Import":
    ...
    with col_metric:
        ...
        with col_bar:
            ...
            fig = px.bar(data, x='Pays/Région', y='Quantité', color='Quantité', color_continuous_scale=rgba(243,189,29,0.8), labels={'Quantité': 'Quantité vendue', 'Pays/Région': 'Pays/Région'})
