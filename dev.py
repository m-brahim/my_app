...
if selected3 == "Import":
    ...
    with col_metric:
        ...
        plot_metric(
            ...
            suffix="€", 
            show_graph=True, 
            color_graph="rgba(243,189,29,0.2)"
        )
        ...
        with col_bar:
            ...
            fig = px.bar(data, x='Pays/Région', y='Quantité', color='Quantité', color_continuous_scale=['#ffe680', '#fcc200'], labels={'Quantité': 'Quantité vendue', 'Pays/Région': 'Pays/Région'})
